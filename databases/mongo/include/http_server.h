...
class HttpServer {
 public:
  ...
  void StartServer() {
    MongoDbHandler mhandler;
    // mhandler.AddCharacterToDb("Gor", CharacterSize::kLarge, 10);
    // mhandler.AddCharacterToDb("Xaxpa", CharacterSize::kSmall, 0);
    // mhandler.AddCharacterToDb("Chatlax", CharacterSize::kMedium, 5);
